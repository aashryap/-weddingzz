    ...
    <span class="sr-only">Next</span>
	  ...
	  { 
         ...
         while($row = mysql_fetch_array($result))
		 {
            ...
            echo "<div class='img-responsive' style='background-image:url(indian-wedding-tradition-ceremony-pandit.jpg);height:400px;width:100%;font-family:Josefin Sans;font-size:30px;overflow:hidden;position:relative;background-size:cover;' >";
          ...
          <div class='tab-content' style='font-family:ABeeZee;margin-top:20px'>
			 ...
			 <div role='tabpanel' class='tab-pane' id='Rate' style='font-size:20px'>
			    <div class='row'>
				     <div class='col-xs-12 col-lg-4'><b>Grand package (wedding ceremony and other pujas )</b></div>
					 <div class='col-xs-12 col-lg-8'>10000 Rs</div>
				</div>
                <div class='row'>				
					 <div class='col-xs-12 col-lg-4'><b>Normal package(only wedding ceremony)</b></div>
			        ...
			        <div class='carousel'>
                        ...
                        <div class='carousel-inner' role='listbox'>
                               <div class='item active' height='200px'>
                                     <img src='pandit-in-jaipur-076.jpg' alt='' style='overflow:hidden;position:relative;background-size:cover'>
                                </div>

                        <div class='item' style='' height='200px'>
                                 <img src='pandit.jpg' alt='' class='' style='overflow:hidden;position:relative;background-size:cover'>
                         </div>
