    ...
    <span class="sr-only">Next</span>
	  ...
	  { 
         ...
         while($row = mysql_fetch_array($result))
		 {
            ...
            echo "<div class='img-responsive' style='background-image:url(austin-wedding-dj-anthony-conforti.jpg);height:400px;width:100%;font-family:Josefin Sans;font-size:30px;overflow:hidden;position:relative;background-size:cover;' >";
          ...
          <div class='tab-content' style='font-family:ABeeZee;margin-top:20px'>
			 ...
			 <div role='tabpanel' class='tab-pane' id='Rate' style='font-size:20px'>
			    <div class='row'>
				     <div class='col-xs-12 col-lg-4'><b>Price per hour</b></div>
					 <div class='col-xs-12 col-lg-8'>1000 Rs</div>
					 <div class='col-xs-12 col-lg-4'><b>Our own music system charge</b></div>
					 <div class='col-xs-12 col-lg-8'>5000 Rs</div>
					  <div class='col-xs-12 col-lg-4'><b>Dico lights</b></div>
					 <div class='col-xs-12 col-lg-8'>7000 Rs</div>
			        ...
			        <div class='carousel'>
                        ...
                        <div class='carousel-inner' role='listbox'>
                               <div class='item active' height='200px'>
                                     <img src='dj-impact-private-event-ruby-reception-suit (1).jpg' alt='' style='overflow:hidden;position:relative;background-size:cover'>
                                </div>

                        <div class='item' style='' height='200px'>
                                 <img src='ShivaniAndVivekArtistPicks-1002.jpg' alt='' class='' style='overflow:hidden;position:relative;background-size:cover'>
                         </div>
