    ...
    <span class="sr-only">Next</span>
	  ...
	  { 
         ...
         while($row = mysql_fetch_array($result))
		 {
            ...
            echo "<div class='img-responsive' style='background-image:url(Color-Scheme-of-Indian-Wedding-Mandap.jpg);height:400px;width:100%;font-family:Josefin Sans;font-size:30px;overflow:hidden;position:relative;background-size:cover;' >";
           ...
           echo "<div class='tabpanel' style='margin-top:30px;border-bottom:solid'>
	        <ul class='nav nav-tabs' role='tablist' style='font-family:Comfortaa;font-size:20px'>
			      ...
			      <li role='presentation' class='action'><a href='#Videos' aria-controls='vedios' role='tab' data-toggle='tab'>Videos</a></li>
				   <li role='presentation' class='action'><a href='#Location' aria-controls='Location' role='tab' data-toggle='tab'>Location</a></li>
			</ul>
          <div class='tab-content' style='font-family:ABeeZee;margin-top:20px'>
		     <div role='tabpanel' class='tab-pane fade in active' id='Info' style='font-size:20px'>
				  ...
				  <div class='row'>
					 ...
					 <div class='col-xs-12 col-xs-8'>
					     All kinds of decoration for main reception,mandap,pujas etc
				     </div>
				  </div>
				  <div class='row'>
				     <div class='col-xs-12 col-lg-4'>
			 ...
			 <div role='tabpanel' class='tab-pane' id='Rate' style='font-size:20px'>
			    <div class='row'>
				     <div class='col-xs-12 col-lg-4'><b>Gold package(Includes stage,decoration for main reception and 2 other function</b></div>
					 <div class='col-xs-12 col-lg-8'>100000 Rs</div>
			    </div>
                <div class='row'>				
					 <div class='col-xs-12 col-lg-4'><b>Silver package(Includes stage,decoration for main reception and 1 function)</b></div>
					 <div class='col-xs-12 col-lg-8'>80000 Rs</div>
				</div>	  
				<div class='row'>
					  <div class='col-xs-12 col-lg-4'><b>Bronze package(Includes main reception and stage decoration)</b></div>
					 <div class='col-xs-12 col-lg-8'>60000 Rs</div>
				</div>	 
			        ...
			        <div class='carousel'>
                        ...
                        <div class='carousel-inner' role='listbox'>
                               <div class='item active' height='200px'>
                                     <img src='indian-wedding-decoration-ideas-for-home.jpg' alt='' style='overflow:hidden;position:relative;background-size:cover'>
                                </div>

                        <div class='item' style='' height='200px'>
                                 <img src='Color-Scheme-of-Indian-Wedding-Mandap.jpg' alt='' class='' style='overflow:hidden;position:relative;background-size:cover'>
                         </div>

                         <div class='item' height='200px'>
                             <img src='decorator.jpg' alt='' style='overflow:hidden;position:relative;background-size:cover'>
                         </div>
                     </div>
