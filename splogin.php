...
<?php
	 ...
	 {  
	  ...
	  if($dbfound)
	  {
		...
		$sql = "select * from serviceprovider where spemail='$email' and password='$password'";
   ...
   <form role="form" method="post"> 
	  ...
	  <div class="form-group">
	    <div class="row">
			...
			<div class="col-lg-8 col-xs-12">
			   <button type="submit" class="btn btn-lg" name="signin" form-control" id="signinsubmit" style="background-color:#ec5f5f;width:100%">Login               </button> 
		    </div>
		</div>
	  </div>	
  </form>  
