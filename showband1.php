    ...
    <span class="sr-only">Next</span>
	  ...
	  { 
         ...
         while($row = mysql_fetch_array($result))
		 {
            ...
            echo "<div class='img-responsive' style='background-image:url(band4.jpg);height:400px;width:100%;font-family:Josefin Sans;font-size:30px;overflow:hidden;position:relative;background-size:cover;' >";
          ...
          <div class='tab-content' style='font-family:ABeeZee;margin-top:20px'>
			 ...
			 <div role='tabpanel' class='tab-pane' id='Rate' style='font-size:20px'>
			    <div class='row'>
				     <div class='col-xs-12 col-lg-4'><b>Band</b></div>
					 <div class='col-xs-12 col-lg-8'>10000 Rs</div>
                </div>	
                <div class='row'>
				     <div class='col-xs-12 col-lg-4'><b>Ghodi</b></div>
					 <div class='col-xs-12 col-lg-8'>5000 Rs</div>
                </div>	
                <div class='row'>
				     <div class='col-xs-12 col-lg-4'><b>Bugghy</b></div>
					 <div class='col-xs-12 col-lg-8'>8000 Rs</div>
                </div>	 				
				<div class='row'>
				     <div class='col-xs-12 col-lg-4'><b>Orchestra performance</b></div>
					 <div class='col-xs-12 col-lg-8'>3000 Rs/hour</div>
                </div>	
			 </div>
			        ...
			        <div class='carousel'>
                        ...
                        <div class='carousel-inner' role='listbox'>
                               <div class='item active' height='200px'>
                                     <img src='rajkumar.jpg' alt='' style='overflow:hidden;position:relative;background-size:cover'>
                                </div>

                        <div class='item' style='' height='200px'>
                                 <img src='rajkumar2.jpg' alt='' class='' style='overflow:hidden;position:relative;background-size:cover'>
                         </div>

                         <div class='item' height='200px'>
                             <img src='rajkumar3.jpg' alt='' style='overflow:hidden;position:relative;background-size:cover'>
                         </div>
                     </div>
