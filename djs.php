...
<?php
  ...
  else
  {
	 ...
	 $username = "root";
	  ...
	  if($dbfound)
	  { 
         $sql = "select spname,spaddress from serviceprovider where sptype= 'Dj'"; 
	     $result = mysql_query($sql);
		 echo "<div class='container'>
                 <div class='row' style='background-color:' >
	                <div class='col-xs-12' style='font-family:Pacifico;font-size:100px;text-align:center;color:#ec5f5f'>Djs</h1>
	             </div>
				 </div>";
		 echo "
	  ...
	  var name = obj.innerHTML;
	   ...
	   //name = name+ ".php";
        //name = name.replace(' ', '');	   
			  ...
			  window.location.href = "showdjs.php?name="+name;
