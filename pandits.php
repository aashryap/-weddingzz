...
<?php
  ...
  else
  {
	 ...
	 $username = "root";
	  ...
	  if($dbfound)
	  { 
         $sql = "select spname,spaddress from serviceprovider where sptype= 'pandit'"; 
	     $result = mysql_query($sql);
		 echo "<div class='container'>
                 <div class='row' style='background-color:' >
	                <div class='col-xs-12' style='font-family:Pacifico;font-size:100px;text-align:center;color:#ec5f5f'>Pandits</h1>
	             </div>
				 </div>";
		 echo "
	  ...
	  var name = obj.innerHTML;
	   ...
	   //name = name+ ".php";
        //name = name.replace(' ', '');	   
			  ...
			  window.location.href = "showpandits.php?name="+name;
